(function(){
    ...
    message.on("focusout", function(){
        if($(this).val() == ""){
                ...
                $("#cancel1").remove();
                $("#bad-message").remove();
                message.after('<img id="cancel1" src="./static/img/redes/cancel.png" width="28" height="28">');
                ...
                $("#cancel1").remove();
                $("#ok1").remove();
                message.after('<img id="ok1" src="./static/img/redes/check.png" width="28" height="28">');
                $("#bad-message").remove();
        }
    });
    email.on("focusout", function(){
        if($(this).val() == "" || $("#email").val().indexOf("@") == -1 || $("#email").val().indexOf(".") == -1){
                ...
                $("#cancel2").remove();
                $("#bad-email").remove();
                email.after('<img id="cancel2" src="./static/img/redes/cancel.png" width="28" height="28">');
                ...
                $("#ok2").remove();
                $("#bad-email").remove();
                email.after('<img id="ok2" src="./static/img/redes/check.png" width="28" height="28">');
                $("#bad-email").remove();
        }
    });
    name.on("focusout", function(){
        if($(this).val() == ""){
            ...
            name.before('<p id="bonito-nombre">Bonito nombre!.</p>');
                ...
                $("#cancel3").remove();
                $("#ok3").remove();
                name.after('<img id="ok3" src="./static/img/redes/check.png" width="28" height="28">');
                $("#bad-name").remove();
        }
